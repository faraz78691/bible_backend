...
router.post("/sendEmail",auth, bibleController.sendEmail);
router.post("/deleteVerses",auth, bibleController.deleteVerses);
router.post("/deleteTempalte", bibleController.deleteTempalte);
